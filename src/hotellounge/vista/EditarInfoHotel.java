 ...
 * @author jmora
 */
public class EditarInfoHotel extends VentanaBase_admin {

    public EditarInfoHotel() {
        ...
        JLabel titulo1 = new javax.swing.JLabel("Editar informacion del hotel", SwingConstants.CENTER);
