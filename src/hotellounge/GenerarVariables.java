...
public class GenerarVariables {
    ...
    public GenerarVariables() {
        ...
        Principal.addActividad(new Actividad(1, "Restaurante", "Restaurante familiar estilo buffet.", "8am", "8pm", 5000));
        Principal.addActividad(new Actividad(2, "Bar", "Bar para mayores de edad.", "7pm", "1am", 3000));
        Principal.addActividad(new Actividad(3, "Tour", "Tour a caballo por el sendero de la montaña.", "6am", "4pm", 8000));
        Principal.addActividad(new Actividad(4, "Canopy", "Canopy por nuestros bosques.", "8am", "6pm", 12000));
    }
